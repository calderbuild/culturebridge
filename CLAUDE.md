...
- **LLM**：DeepSeek V4（分析/审校，$0.30/M tokens）+ Claude Sonnet 4.6（翻译输出，多语种质量高）。千字成本约 $0.07
- **文化知识库**：`backend/knowledge/mappings/*.json`，100+ 条文化概念映射，跨内容形态通用
...
- `palace.json` — 宫廷（臣妾/本宫/冤家等，40 条）
- `wuxia.json` — 武侠（20 条）
- `xianxia.json` — 修仙/玄幻（渡劫/金丹/元婴等，20 条）
- `modern.json` — 都市（20 条）
